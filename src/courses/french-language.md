...
## Provided
- AP® French {{ site.currentYear }} participants folder
- Electronic access to publisher materials
- Handouts (electronic)

## Schedule
### Monday, Day 1
#### Introduction
- The AP® {{ site.currentYear }} exam - general overview / New format for 2026/27 (Synchronous)
- Components of the AP® {{ site.currentYear }} exam / New format for 2026/27
- Provide ideas and strategies for the lower-level French classes
- Problem solving - discussion of challenges in the classroom (Synchronous) 1 hour
- Textbooks, workbooks and supplemental materials (Synchronous) 30 mins
- AP® French course exam description / AP&reg; Equity & Access policy (1 hr)
...
- Listening/reading and speaking
    ...
    - Strategies for teaching listening and reading (including sample materials) (Synchronous) 1 hr
...
- {{ site.currentYear }} exam (section 1 portion)
- AP® Scoring rubric Task 3 and 4

### Wednesday, Day 3
#### Writing/grammar
- Writing the composition {{ site.currentYear }} / New exam format
- Strategies for teaching composition development (Synchronous) 1.5 hrs
- Support materials
- Test samples from these sections
- Syllabus writing
- {{ site.currentYear }} exam analysis (section 2 writing portion) (Asynchronous) 1 hr
- AP® Scoring rubrics Task 1 and 2
